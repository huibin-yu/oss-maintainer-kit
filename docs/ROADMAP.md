...
- 支持 SARIF 2.1.0 输出、CodeQL、govulncheck、Dependabot 和 PR diff 扫描 workflow。
...
- 支持 OSSF Scorecard 风格的本地治理内容检查，覆盖 CI 权限、测试构建命令、govulncheck、SARIF 上传、Dependabot 覆盖和 PR 模板提示。
