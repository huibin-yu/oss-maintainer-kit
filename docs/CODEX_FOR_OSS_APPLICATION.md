...
go run ./cmd/oss-maintainer-kit review-diff --diff examples/pr.diff --config examples/review-rules.json --format check-run
GITHUB_TOKEN=ghp_xxx go run ./cmd/oss-maintainer-kit github-check-run --repo owner/name --sha HEAD_SHA --diff examples/pr.diff --config examples/review-rules.json
